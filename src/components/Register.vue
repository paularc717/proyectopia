<template>
  ...
  import { registerSchema as validationSchema } from '@/validation/registerSchema' // Asegúrate de definir este esquema
  ...
  const submit = handleSubmit(async (values) => {
    try {
      await auth.register(values) // Implementa la función register en tu store
      console.log(values)
    } catch (error) {
